package com.crepen.crepenboard.api.module.auth.model.exception;
...
public class AuthException extends ResponseException {
    ...
    public static AuthException UNMATCHED_GRANT_TYPE = new AuthException(403 , "UNMATCHED_GRANT_TYPE" , "error.authorize.unmatched_grant_type");
    ...
    public static AuthException BLOCK_USER = new AuthException(401, "BLOCK_USER" , "error.authorize.block_user");
    public static AuthException UNMATCHED_PASSWORD= new AuthException(401, "UNMATCHED_PASSWORD" , "error.authorize.unmatched_password");
}
